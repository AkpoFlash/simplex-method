...
2) С GitHub
Скачиваете все исходники из репозитория simplex-method (https://github.com/AkpoFlash/simplex-method) с помощью любого компилятора создаем исполняемый файл, все осталные данные о программе хранятся в файле Readme.txt.
